      ...
      children: [
        ...
        Text(
          widget.currentData.title ??
              ...
              "NO Data",
          style: AppThemeConstants.appFont.withSize(18).withWeight(),
          maxLines: 1,
            ...
            children: [
              Column(
                children: [
                  Row(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text("${widget.currentData.voteAverage}",
                  ...
                  Text("${widget.currentData.voteCount}")
                ],
              ),
              Column(
                children: [
                  Row(
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsets.only(left: 3.0),
                        child: Text("${widget.currentData.popularity}",
                            style: AppThemeConstants.appFontAccent
                                                                  ...
                                                                  (index) =>
                                                                      Padding(
                                                                        padding: const EdgeInsets.only(
                                                                            ...
                                                                            top:
                                                                                8.0),
                                                                        child: Text(detailManager.detailsData.genres[index].name +
                                                                            "${index == detailManager.detailsData.genres.length - 1 ? "" : "  /"}"),
                                                                      ))
                                                            ],
                                                          ),
                                                                    ...
                                                                    child: TabBarView(
                                                                        ...
                                                                        children: List.generate(
                                                                          ...
                                                                          (index) =>
                                                                            ...
                                                                            child:
                                                                                Container(height: 120, child: CastCrewList(detailManager: detailManager, isCrew: index == 1)),
                                                                          ),
                                                                        )),
                                                                  )
                                                                ],
